...
{{--                        <a class="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0" href="#">Add Product</a>--}}
                        <button data-modal-target="crud-modal" data-modal-toggle="crud-modal" class="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0" type="button">
                            Add Product
                        </button>
                        <!-- Modal toggle -->
                        <button data-modal-target="crud-modal-category" data-modal-toggle="crud-modal-category" class="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0" type="button">
                            Add Category
                        </button>
...
{{--                        <a class="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0" href="#">Logout</a>--}}
                    ...
                    <div class='flex items-center justify-center'>
                        <ul class="mx-auto grid max-w-full w-full grid-cols-3 gap-x-5 px-8">
                            <li class="">
                                ...
                                <label class="flex justify-center cursor-pointer rounded-full border border-gray-300 bg-white py-2 px-4 hover:bg-gray-50 focus:outline-none peer-checked:border-transparent peer-checked:ring-2 peer-checked:ring-indigo-500 transition-all duration-500 ease-in-out" for="yes">All</label>
                            </li>
        ...
        <div :class="cartOpen ? 'translate-x-0 ease-out' : 'translate-x-full ease-in'" class="fixed right-0 top-0 max-w-xs w-32 mt-6  transition duration-300 transform overflow-y-auto">
                ...
                <form class="p-4 md:p-5">
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            ...
                            <input type="number" name="price" id="price" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="2999 DH" required="">
                        </div>
                        <div class="col-span-2 sm:col-span-1">
...
{{--    add category form--}}
    <!-- Main modal -->
    <div id="crud-modal-category" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative p-4 w-full max-w-md max-h-full">
            <!-- Modal content -->
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <!-- Modal header -->
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    ...
                    <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="crud-modal-category">
                        <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                        </svg>
                        <span class="sr-only">Close modal</span>
